        ...
        <div className="grid gap-4">
          ...
          <div className="flex justify-center">
            <div className="flex gap-2">
              <Button className="bg-black text-white hover:text-black" onClick={handlePreview}>Generate Preview</Button>
              <Button className="bg-black text-white hover:text-black" onClick={handlePasteHtml}>Paste HTML</Button>
            </div>
          </div>
